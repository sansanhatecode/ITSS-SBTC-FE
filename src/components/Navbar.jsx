...
const Navbar = () => {
  ...
  const isActive = (path) => {
    return location.pathname === path ? 'text-blue-600 dark:text-blue-400 font-medium' : 'text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400';
  };
      ...
      >
        <div className="container mx-auto px-4 py-3">
          <div className="flex flex-col space-y-4 pb-3">
            <Link
              to="/"
              className={`${isActive('/')} block py-2 transition-colors duration-300`}
            >
              Home
            </Link>
            <Link
              to="/about"
              className={`${isActive('/about')} block py-2 transition-colors duration-300`}
            >
              About
            </Link>
            <a
              href="#"
              className="py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white text-center rounded-md transition-colors duration-300"
            >
              Create Event
            </a>
          </div>
